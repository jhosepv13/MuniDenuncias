...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void callRegister(View view) {
        ...
        if (titulo.isEmpty() || usuario.isEmpty()) {
            Toast.makeText(this, "Nombre y usuario son campos requeridos", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (mediaFileUri == null) {
            ...
            call = service.createDenuncia(titulo, usuario, contenido);
        } else {
            ...
            call = service.createDenunciaWithImage(tituloPart, usuarioPart, contenidoPart, imagenPart);
        }
